...
(globalThis.webpackChunk = globalThis.webpackChunk || []).push([
  ...
  ],
  {
    66602: (e, t, s) => {
      ...
      (0, a.N7)(".js-comment-header-actions-deferred-include-fragment", {
        subscribe: (e) =>
          (0, r.RB)(
            e,
            "loadstart",
        ...
        (0, a.N7)(".js-comment .contains-task-list", {
          add: (e) => {
            let t = e.closest(".js-comment");
            j(t);
          },
        ...
        (0, n.on)("click", ".js-comment-edit-button", function (e) {
          ...
          let s = f(t);
          s
            ? s.addEventListener("include-fragment-replaced", () => d(t), {
                once: !0,
              })
            : d(t);
        ...
        (0, n.on)("click", ".js-comment-cancel-button", g),
        ...
        (0, m.AC)(".js-comment .js-comment-update", async function (e, t) {
          let s;
          let n = e.closest(".js-comment"),
            i = n.querySelector(".js-comment-update-error"),
            r = n.querySelector(".js-comment-body-error");
            ...
            if (422 === e.response.status) {
              ...
              if (t.errors) {
                i instanceof HTMLElement &&
                  ((i.textContent = `There was an error posting your comment: ${t.errors.join(
                    ", "
                  )}`),
                  (i.hidden = !1));
                return;
          ...
          if (!s) return;
          let a = s.json;
          a.errors && a.errors.length > 0 && ((u = a.errors), y(r));
          ...
          if ((m && a.body && !c && (m.innerHTML = a.body), null != a.source)) {
            ...
            if (
              (e && ((e.defaultValue = a.source), c || (e.value = a.source)),
              a.default_merge_commit_message)
            ) {
              if (document.querySelector(".js-merge-pr.is-merging")) {
                ...
                e instanceof HTMLTextAreaElement &&
                  ...
                  (e.value = e.defaultValue = a.default_merge_commit_message);
              }
              if (
                a.default_squash_commit_message &&
                ...
                e instanceof HTMLTextAreaElement &&
                  e.value === e.defaultValue &&
                  (e.value = e.defaultValue = a.default_squash_commit_message);
              }
            }
            document
          ...
          for (let e of (f && a.poll && (f.innerHTML = a.poll),
          ...
          if (j) {
            let e = await (0, o.a_)(document, a.editUrl);
            (j.textContent = ""), j.append(e);
          }
        }),
        (0, a.N7)(".js-comment-body-error", {
          add: (e) => {
            u && u.length > 0 && y(e);
          },
        }),
        ...
        (0, m.AC)(".js-comment-delete", async function (e, t) {
          await t.json();
          ...
          if (
            (s?.remove(), n && 1 === n.querySelectorAll(".js-comment").length)
          )
        ...
        (0, m.AC)(".js-issue-update", async function (e, t) {
          let s;
            ...
            if (e) {
              ...
              t &&
                t.setAttribute(
                  ...
                  o.default_merge_commit_title
                );
              let s = e.querySelector("button[value=squash]");
              s &&
                s.setAttribute(
                  "data-input-title-value",
                  o.default_squash_commit_title
                );
            }
          }
        ...
        (0, m.AC)(".js-comment-minimize", async function (e, t) {
          await t.json();
          ...
          if (n && n.classList.contains("js-update-minimized-content")) {
            ...
            i && i.classList.remove("d-none"),
              i && i.classList.add("js-comment");
          }
        }),
        (0, m.AC)(".js-comment-unminimize", async function (e, t) {
          await t.json();
          let s = e.closest(".js-minimizable-comment-group"),
